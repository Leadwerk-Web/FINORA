<?php
/**
 * FINORA Leadwerk theme integration.
 *
...
$leadwerk_structured_render_file = LEADWERK_THEME_DIR . '/inc/structured-finora-render.php';
if ( is_file( $leadwerk_structured_render_file ) ) {
	require_once $leadwerk_structured_render_file;
}

$leadwerk_exact_render_file = LEADWERK_THEME_DIR . '/inc/exact-finora-render.php';
...
function leadwerk_theme_enqueue_assets() {
	...
	wp_enqueue_style( 'leadwerk-theme-fonts', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;700&family=Plus+Jakarta+Sans:wght@200;300;400;600;700&display=swap', array(), null );
	wp_enqueue_style( 'leadwerk-theme-icons', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css', array(), '6.4.0' );
...
/**
 * Feed rendered FINORA page content into Yoast's content analysis.
 *
...
$blocks = array(
'leadwerk-finora-page'   => 'leadwerk_theme_render_page_block',
'leadwerk-finora-header' => 'leadwerk_theme_render_header_block',
'leadwerk-finora-footer' => 'leadwerk_theme_render_footer_block',
);
...
if ( 'finora-home-v1' === $source_key ) {
$classes[] = 'home';
}
if ( 'finora-404-v1' === $source_key ) {
$classes[] = 'page-404';
$classes[] = 'header-scrolled';
}
...
/**
 * Force the rendered Finora header into its scrolled visual state.
 *
...
function leadwerk_theme_render_header_block() {
	if ( function_exists( 'leadwerk_theme_render_exact_site_header' ) ) {
		...
		if ( '' !== trim( $exact_header ) ) {
			if ( is_404() || 'finora-404-v1' === leadwerk_theme_get_current_source_key() ) {
	...
	$de_url          = leadwerk_theme_get_page_url( leadwerk_theme_get_current_source_key(), 'de', home_url( '/' ) );
	$en_url          = leadwerk_theme_get_page_url( leadwerk_theme_get_current_source_key(), 'en', home_url( '/en/' ) );
	...
	<header class="site-header">
		<div class="header-row">
			<div class="header-logo">
				<a href="<?php echo esc_url( $home_url ); ?>">
					<img src="<?php echo esc_url( leadwerk_theme_get_option_image_url( 'header_logo', 'assets/images/Logo-final-weiss-rz_svg.svg' ) ); ?>" alt="Finora Investment Studio" width="920" height="210">
				</a>
			</div>
			<nav class="header-nav">
				<ul class="nav-menu">
					<li class="<?php echo $is_service_page ? 'is-active' : ''; ?>">
						<a href="#"><?php echo esc_html( $service_label ); ?></a>
						<ul class="sub-menu">
							<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-retirement-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-retirement-v1', $lang, 'Altersvorsorge-Beratung' ) ); ?></a></li>
							<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-investment-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-investment-v1', $lang, 'Investment-Beratung' ) ); ?></a></li>
							<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-real-estate-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-real-estate-v1', $lang, 'Immobilien-Beratung' ) ); ?></a></li>
							<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-inheritance-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-inheritance-v1', $lang, 'Erbanlage-Beratung' ) ); ?></a></li>
						</ul>
					</li>
					<li><a class="<?php echo leadwerk_theme_is_source_key( 'finora-philosophy-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-philosophy-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-philosophy-v1', $lang, 'Finora-Philosophie' ) ); ?></a></li>
					<li><a class="<?php echo leadwerk_theme_is_source_key( 'finora-about-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-about-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-about-v1', $lang, 'Über Finora' ) ); ?></a></li>
					<li><a class="<?php echo leadwerk_theme_is_source_key( 'finora-contact-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-contact-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-contact-v1', $lang, 'Kontakt' ) ); ?></a></li>
				</ul>
			</nav>
		...
		<div class="mobile-menu">
			<a href="#"><?php echo esc_html( $service_label ); ?></a>
			<div class="sub-menu">
				<a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-retirement-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-retirement-v1', $lang, 'Altersvorsorge-Beratung' ) ); ?></a>
				<a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-investment-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-investment-v1', $lang, 'Investment-Beratung' ) ); ?></a>
				<a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-real-estate-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-real-estate-v1', $lang, 'Immobilien-Beratung' ) ); ?></a>
				<a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-inheritance-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-inheritance-v1', $lang, 'Erbanlage-Beratung' ) ); ?></a>
			</div>
			<a class="<?php echo leadwerk_theme_is_source_key( 'finora-philosophy-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-philosophy-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-philosophy-v1', $lang, 'Finora-Philosophie' ) ); ?></a>
			<a class="<?php echo leadwerk_theme_is_source_key( 'finora-about-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-about-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-about-v1', $lang, 'Über Finora' ) ); ?></a>
			<a class="<?php echo leadwerk_theme_is_source_key( 'finora-contact-v1' ) ? 'is-active' : ''; ?>" href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-contact-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-contact-v1', $lang, 'Kontakt' ) ); ?></a>
...
function leadwerk_theme_render_footer_block() {
	...
	$address          = nl2br( esc_html( leadwerk_theme_get_option_value( 'company_address', "Brauerstr. 17\n76137 Karlsruhe" ) ) );
	...
	<footer class="site-footer">
		<div class="footer-main">
			<div class="footer-col">
				<img src="<?php echo esc_url( leadwerk_theme_get_option_image_url( 'footer_logo', 'assets/images/Logo-final-weiss-rz.png' ) ); ?>" alt="Finora Logo" class="footer-logo" width="922" height="212" loading="lazy">
				<p class="footer-desc"><?php echo esc_html( $strings[ $footer_desc_key ] ?? '' ); ?></p>
			</div>
			<div class="footer-col">
				<h4><?php echo esc_html( $strings['footer_menu_heading'] ?? 'Menü' ); ?></h4>
				<ul>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-home-v1', $lang ) ); ?>"><?php echo esc_html( $strings['footer_menu_home'] ?? 'Startseite' ); ?></a></li>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-philosophy-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-philosophy-v1', $lang, 'Finora-Philosophie' ) ); ?></a></li>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-about-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-about-v1', $lang, 'Über Finora' ) ); ?></a></li>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-contact-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-contact-v1', $lang, 'Kontakt' ) ); ?></a></li>
				</ul>
			</div>
			<div class="footer-col">
				<h4><?php echo esc_html( $strings['footer_topics_heading'] ?? 'Themen' ); ?></h4>
				<ul>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-retirement-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-retirement-v1', $lang, 'Altersvorsorge-Beratung' ) ); ?></a></li>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-investment-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-investment-v1', $lang, 'Investment-Beratung' ) ); ?></a></li>
					<li><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-real-estate-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-real-estate-v1', $lang, 'Immobilien-Beratung' ) ); ?></a></li>
		...
		<div class="footer-logo-full">
			<img src="<?php echo esc_url( leadwerk_theme_get_option_image_url( 'footer_wordmark', 'assets/images/Schriftzug.svg' ) ); ?>" alt="Finora" class="footer-logo-full__img" width="972" height="176" loading="lazy">
			<div class="footer-logo-full__gradient" aria-hidden="true"></div>
		</div>
		<div class="footer-bottom">
			<p><a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-impressum-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-impressum-v1', $lang, 'Impressum' ) ); ?></a>&nbsp; &nbsp; &nbsp;|&nbsp; &nbsp; &nbsp;<a href="<?php echo esc_url( leadwerk_theme_get_page_url( 'finora-datenschutz-v1', $lang ) ); ?>"><?php echo esc_html( leadwerk_theme_get_page_title( 'finora-datenschutz-v1', $lang, 'Datenschutz' ) ); ?></a></p>
		</div>
	</footer>
	<?php
...
function leadwerk_theme_is_legal_source_key( $source_key ) {
	return in_array( $source_key, array( 'finora-impressum-v1', 'finora-datenschutz-v1' ), true );
}
...
function leadwerk_theme_get_theme_strings( $lang = null ) {
	...
	$defaults = 'en' === $lang
		? array(
			...
			'footer_desc_home' => 'Independent financial advice for expats, heirs, young professionals, employees, the self-employed and ETF investors. Specialized in retirement planning, investments, real estate and tax-optimized strategies.',
			'footer_desc_general' => 'Finora offers independent investment and financial advice in Germany. Focus: Retirement Planning, investments, real estate and tax-optimized structuring, clearly explained and supported in a structured manner.',
			'footer_desc_legal' => 'Finora offers independent financial advice for expats, heirs, young professionals, employees, self-employed people and ETF investors in Germany. Specialized in retirement planning, investments, real estate and tax-optimized strategies.',
		...
		: array(
			...
			'footer_desc_home' => 'Unabhängige Finanzberatung für Expats, Erben, Berufseinsteiger, Angestellte, Selbstständige und ETF-Investoren. Spezialisiert auf Altersvorsorge, Investment, Immobilien und steueroptimierte Strategien.',
			'footer_desc_general' => 'Finora bietet unabhängige Investment- und Finanzberatung in Deutschland. Fokus: Altersvorsorge, Investment, Immobilien und steueroptimierte Strukturierung, verständlich erklärt und strukturiert begleitet.',
			'footer_desc_legal' => 'Finora bietet unabhängige Finanzberatung für Expats, Erben, Berufseinsteiger, Angestellte, Selbstständige und ETF-Investoren in Deutschland. Spezialisiert auf Altersvorsorge, Investment, Immobilien und steueroptimierte Strategien.',
