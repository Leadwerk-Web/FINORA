...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && mobileMenu) {
        ...
        function closeMenu() {
            ...
            syncLiquidGlass(document.querySelector('.site-header'));
        }
    ...
    accordionItems.forEach(item => {
        ...
        title.addEventListener('click', () => {
            ...
            syncLiquidGlass(item.closest('.faq') || item.closest('.section-faq') || item.parentElement);
        });
    });
    ...
    document.querySelectorAll('.timeline.timeline--horizontal .timeline-item__card').forEach(function (card) {
        ...
        btn.addEventListener('click', function () {
            ...
            syncLiquidGlass(card.closest('.timeline') || card);
        });
    });
    ...
    tabNavs.forEach(nav => {
        ...
        buttons.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                syncLiquidGlass(nav.parentElement);
            });
        });
    });
    ...
    if (audienceNav) {
        ...
        links.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                if (target) target.classList.add('is-active');
                syncLiquidGlass(target || audienceNav.parentElement);
            });
        });
    }
